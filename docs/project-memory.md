...
- 2026-06-10 10:48 CST 已部署到唯一生产域名 `https://zaomengai.icu`；服务器 `/home/ubuntu/zaomeng/.deploy-sha` 为 `ed682df`。公网验证 `/market`、`/api/plugin/version` 和固定背景资源 `/assets/market-hero/dev-market-01.webp` 正常返回。
