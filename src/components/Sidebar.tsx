      ...
      icon: (
        ...
        >
          <path
            ...
            strokeWidth={2}
            d="M5 9h14l-1.2-4.2A1.2 1.2 0 0016.65 4H7.35a1.2 1.2 0 00-1.15.8L5 9z"
          />
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth={2}
            d="M5 9v1.2A2.8 2.8 0 007.8 13 2.8 2.8 0 0010.6 10.2V9M10.6 9v1.2A2.8 2.8 0 0013.4 13a2.8 2.8 0 002.8-2.8V9M16.2 9v1.2A2.8 2.8 0 0019 13"
          />
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth={2}
            d="M6.5 13.5V19a1 1 0 001 1h9a1 1 0 001-1v-5.5"
          />
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth={2}
            d="M9 18l1.8-1.8a1 1 0 011.4 0L14 18m-.8-3.7h.01"
          />
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth={2}
            d="M18.5 17.5h1.5m-.75-.75v1.5"
          />
        </svg>
      ),
    },
