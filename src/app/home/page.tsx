  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 h-[700px] w-[700px] animate-pulse rounded-full bg-blue-600/12 blur-[120px]"
          style={{ animationDelay: "1.5s" }}
        />
        <div
          className="absolute left-1/2 top-1/2 h-[900px] w-[900px] -translate-x-1/2 -translate-y-1/2 animate-pulse rounded-full bg-indigo-600/8 blur-[120px]"
