            ...
            {activeTab === "market" && !marketBrowseLocked ? (
              <section className="relative left-1/2 mb-[-12vh] min-h-[calc(100svh-8rem)] w-screen -translate-x-1/2 overflow-hidden pb-[18vh] sm:-ml-8 sm:mb-[-22vh] sm:min-h-[calc(100vh-5rem)] sm:pb-[28vh]">
                <div className="absolute inset-0">
                  ...
                  <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(0,0,0,0.38),rgba(0,0,0,0.08)_28%,rgba(0,0,0,0.08)_72%,rgba(0,0,0,0.38))]" />
                  <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.28),rgba(0,0,0,0.04)_42%,rgba(0,0,0,0.46)_78%,rgba(0,0,0,0.82))]" />
                  <div className="absolute inset-x-0 bottom-0 h-[46vh] bg-[linear-gradient(180deg,transparent,rgba(0,0,0,0.08)_18%,rgba(0,0,0,0.32)_58%,rgba(0,0,0,0.82))]" />
                </div>
