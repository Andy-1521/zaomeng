...
const FAST_VISION_MODEL = 'gpt-4o';
const FALLBACK_VISION_MODELS = ['gpt-5.4-mini', 'gpt-5.4'];
...
前两张图分别是点击位置附近的近景裁切和更近距离特写，最后一张是原图缩略总览。请优先参考前两张图的中心区域，再结合最后一张图的整体语境，识别这个点击点本身最准确的单个标签。
